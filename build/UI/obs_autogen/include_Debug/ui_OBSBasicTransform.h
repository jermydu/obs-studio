...
public:
    ...
    void setupUi(QDialog *OBSBasicTransform)
    {
        ...
        OBSBasicTransform->resize(564, 313);
        ...
        widget = new QFrame(OBSBasicTransform);
        ...
        widget_2 = new QFrame(OBSBasicTransform);
        ...
        widget_3 = new QFrame(OBSBasicTransform);
        ...
        transformSpacer = new QSpacerItem(0, 10, QSizePolicy::Minimum, QSizePolicy::Expanding);
