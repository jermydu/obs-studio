...
QT_MOC_LITERAL(4, 83, 14) // "PrioritizeVCam"

    },
    "AutoConfigStartPage\0on_prioritizeStreaming_clicked\0"
    "\0on_prioritizeRecording_clicked\0"
    "PrioritizeVCam"
};
#undef QT_MOC_LITERAL
...
QT_MOC_LITERAL(8, 146, 18), // "UpdateMoreInfoLink"
QT_MOC_LITERAL(9, 165, 16), // "UpdateServerList"
QT_MOC_LITERAL(10, 182, 15), // "UpdateCompleted"
QT_MOC_LITERAL(11, 198, 23), // "reset_service_ui_fields"
QT_MOC_LITERAL(12, 222, 12), // "std::string&"
QT_MOC_LITERAL(13, 235, 7) // "service"
    ...
    "UpdateKeyLink\0UpdateMoreInfoLink\0"
    "UpdateServerList\0UpdateCompleted\0"
    "reset_service_ui_fields\0std::string&\0"
    "service"
};
#undef QT_MOC_LITERAL
...
void AutoConfigStreamPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->reset_service_ui_fields((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
