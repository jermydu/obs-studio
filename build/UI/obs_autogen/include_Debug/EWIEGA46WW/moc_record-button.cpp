...
struct qt_meta_stringdata_ControlsSplitButton_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ControlsSplitButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ControlsSplitButton_t qt_meta_stringdata_ControlsSplitButton = {
    {
QT_MOC_LITERAL(0, 0, 19) // "ControlsSplitButton"
...
static const uint qt_meta_data_ControlsSplitButton[] = {
...
QT_INIT_METAOBJECT const QMetaObject ControlsSplitButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QHBoxLayout::staticMetaObject>(),
    qt_meta_stringdata_ControlsSplitButton.data,
    qt_meta_data_ControlsSplitButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ControlsSplitButton.stringdata0))
        return static_cast<void*>(this);
