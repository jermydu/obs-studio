...
QT_MOC_LITERAL(12, 122, 12) // "NewGroupEdit"
...
void SourceTree::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { bool _r = _t->Edit((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 7: _t->NewGroupEdit((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
