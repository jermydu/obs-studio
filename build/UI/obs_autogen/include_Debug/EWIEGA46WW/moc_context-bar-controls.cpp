...
#include <memory>
#include "../../../../../UI/context-bar-controls.hpp"
...
struct qt_meta_stringdata_ApplicationAudioCaptureToolbar_t {
    QByteArrayData data[1];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ApplicationAudioCaptureToolbar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ApplicationAudioCaptureToolbar_t qt_meta_stringdata_ApplicationAudioCaptureToolbar = {
    {
QT_MOC_LITERAL(0, 0, 30) // "ApplicationAudioCaptureToolbar"
...
static const uint qt_meta_data_ApplicationAudioCaptureToolbar[] = {
...
QT_INIT_METAOBJECT const QMetaObject ApplicationAudioCaptureToolbar::staticMetaObject = { {
    QMetaObject::SuperData::link<ComboSelectToolbar::staticMetaObject>(),
    qt_meta_stringdata_ApplicationAudioCaptureToolbar.data,
    qt_meta_data_ApplicationAudioCaptureToolbar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ApplicationAudioCaptureToolbar.stringdata0))
        return static_cast<void*>(this);
    return ComboSelectToolbar::qt_metacast(_clname);
}
