...
#include <memory>
#include "../../../../../UI/win-update/win-update.hpp"
...
QT_MOC_LITERAL(7, 66, 15) // "queryRepairSlot"

    },
    "AutoUpdateThread\0infoMsg\0\0title\0text\0"
    "queryUpdateSlot\0manualUpdate\0"
    "queryRepairSlot"
};
...
void AutoUpdateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->queryRepairSlot();
...
struct qt_meta_stringdata_WhatsNewBrowserInitThread_t {
    QByteArrayData data[4];
    char stringdata0[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WhatsNewBrowserInitThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WhatsNewBrowserInitThread_t qt_meta_stringdata_WhatsNewBrowserInitThread = {
    {
QT_MOC_LITERAL(0, 0, 25), // "WhatsNewBrowserInitThread"
QT_MOC_LITERAL(1, 26, 6), // "Result"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3) // "url"

    },
    "WhatsNewBrowserInitThread\0Result\0\0url"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_WhatsNewBrowserInitThread[] = {
...
void WhatsNewBrowserInitThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WhatsNewBrowserInitThread::Result)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WhatsNewBrowserInitThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_WhatsNewBrowserInitThread.data,
    qt_meta_data_WhatsNewBrowserInitThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_WhatsNewBrowserInitThread.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}
