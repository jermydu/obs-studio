...
#include <memory>
#include "../../../../../../plugins/obs-websocket/src/websocketserver/WebSocketServer.h"
...
QT_MOC_LITERAL(3, 33, 21), // "WebSocketSessionState"
QT_MOC_LITERAL(4, 55, 5), // "state"
QT_MOC_LITERAL(5, 61, 18), // "ClientDisconnected"
QT_MOC_LITERAL(6, 80, 8), // "uint16_t"
QT_MOC_LITERAL(7, 89, 9) // "closeCode"

    },
    "WebSocketServer\0ClientConnected\0\0"
    "WebSocketSessionState\0state\0"
    "ClientDisconnected\0uint16_t\0closeCode"
};
...
void WebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ClientConnected((*reinterpret_cast< WebSocketSessionState(*)>(_a[1]))); break;
        case 1: _t->ClientDisconnected((*reinterpret_cast< WebSocketSessionState(*)>(_a[1])),(*reinterpret_cast< uint16_t(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WebSocketServer::*)(WebSocketSessionState );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebSocketServer::ClientConnected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WebSocketServer::*)(WebSocketSessionState , uint16_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebSocketServer::ClientDisconnected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WebSocketServer::ClientConnected(WebSocketSessionState _t1)
{
...
// SIGNAL 1
void WebSocketServer::ClientDisconnected(WebSocketSessionState _t1, uint16_t _t2)
{
